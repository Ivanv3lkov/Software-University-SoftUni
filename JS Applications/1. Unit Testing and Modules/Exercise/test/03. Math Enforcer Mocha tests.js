...
describe("mathEnforcer", function () {
    describe('addFive', function () {
       it("should return undefined for non-number parameter",function () {
           expect(mathEnforcer.addFive("95")).to.be.equal(undefined);
       });
        ...
        it("should return correct result for floating point parameter", function () {
            expect(mathEnforcer.addFive(1.33)).to.be.closeTo(6.33, 0.01);
        });
    });
...
// use this for testing in the console --->  mocha ./"03. Math Enforcer Mocha tests"